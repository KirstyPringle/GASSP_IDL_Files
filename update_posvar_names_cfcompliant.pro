...
tempvar_str=['ATX','*temp*','AT_3051','TAT_DI_R','T_STAT','St_Air_Tm*','TS','T_AMBIENT','SAMPLE_TEMPERATURE']
...
presvar_str=['PSXC','*pres*','pre','*stat*pres*','BP_915',$
             'STATICPRS','PS_RVSM','P_STAT','Stat_Pr','PSTATIC','PSMB','P_AMBIENT','SAMPLE_PRESSURE']
dpresvar_str=['*QCXC*']
